...
public class CaesarCipher extends BaseCipher
{
    ...
    /**
     * This function compares the passed Object object to see if it is another CaeserCipher Object with
     * the same key. Otherwise, it returns false.
     * @param object a passed object to be compared to a CaesarCipher object
     * @return true or false
     */
    public boolean equals(Object object)
    {
        ...
        {
            if(((CaesarCipher) object).key == key)
            {
                return true;
            }
        }
